...
- 微操作分类
  - 相容性微操作
    - 在同时或同一个`CPU`周期内可以并行执行的微操作
  - 相斥性微操作
    - 不能在同时或不能在同一个`CPU`周期内并行执行的微操作
## 4.2 硬布线控制器
...
![picture 21](../assets/8319058118b7d658691e5efbd39654fbb6b8d4ef728e415fad03156e0bd03fce.png)  
